...
- `ENABLE_EXTRAS=0` (build extra optional libraries; defaults on)
- `ENABLE_FONTS=0` (fonts stack + libass; defaults on)
- `ENABLE_DVD=0` (DVD/BD libraries; defaults on)
- `ENABLE_SYSTEM_EXTRAS=0` (use system libs like X11/Vulkan/OpenCL/SDL2; defaults on)
